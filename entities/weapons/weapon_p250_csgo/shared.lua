...
SWEP.isCSGO = true
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_p250.mdl" --Viewmodel path
SWEP.WorldModel			= "models/weapons/tfa_csgo/w_p250.mdl" -- Weapon world model path

SWEP.ClipSize			=20
SWEP.MaxAmmo			=30

SWEP.Sound			= Sound("TFA_CSGO_P250.1")
SWEP.Recoil			= 0.3
SWEP.Damage			= 28
SWEP.NumShots		= 1
SWEP.ClipSize		= 18
